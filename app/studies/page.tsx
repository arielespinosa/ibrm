            ...
            >
              <div className="relative overflow-hidden aspect-video">
                ...
                <div className="absolute bottom-3 left-3">
                  <span className="bg-[#c9a55a] text-black text-[10px] font-bold px-2 py-0.5 uppercase tracking-wider">
                    {study.book}
                  </span>
                </div>
              </div>
          ...
          {regular.map((study, i) => (
            ...
            >
              <div className="overflow-hidden w-24 h-16 flex-shrink-0 hidden sm:block">
                <img src={study.image} alt={study.title} className="w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity" />
              </div>
              <div>
                <span className="text-[#c9a55a] text-[10px] uppercase tracking-widest">{study.book}</span>
              ...
              <div className="flex items-center gap-4">
                <span className="text-white/20 text-xs hidden md:block">{study.lessons} lecciones</span>
                {study.url ? (
